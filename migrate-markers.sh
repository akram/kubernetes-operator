...
function migrate_displayName() {
  ...
  gsed -i -E 's/'$old_marker_pattern'/'$new_marker_pattern'/g' "$1"
}
...
function migrate_resources() {
  ...
  gsed -i -E 's/'$old_marker_pattern_1'/'$new_marker_pattern_1'/g' "$1"
  gsed -i -E 's/'$old_marker_pattern_2'/'$new_marker_pattern_2'/g' "$1"
}
...
function migrate_typeDescriptors() {
  ...
  gsed -i -E 's/'$old_marker_true_pattern'/'$new_marker_pattern'/g' "$1"
  gsed -i -E 's/'$old_marker_false_pattern'//g' "$1"
}
