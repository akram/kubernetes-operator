...
func NewDockerfileConfigMap(cr *jenkinsv1alpha3.JenkinsImage) *corev1.ConfigMap {
...
func getPluginsList(cr *jenkinsv1alpha3.JenkinsImage) string {
...
func getDefaultedBaseImage(cr *jenkinsv1alpha3.JenkinsImage) string {
...
func getVolumes(cr *jenkinsv1alpha3.JenkinsImage) []corev1.Volume {
...
func getVolumesMounts(cr *jenkinsv1alpha3.JenkinsImage) []corev1.VolumeMount {
	name := fmt.Sprintf(NameWithSuffixFormat, cr.Name, DockerfileStorageSuffix)
